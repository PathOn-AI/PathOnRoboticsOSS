...
| **PathOn Conveyor — Sensor-Triggered Infeed** *(placeholder, files not yet released)* | 3D-printed belt conveyor that feeds the Smart Logistics Cell — carries a block to an IR-monitored pick point, where the sensor firing starts the whole line | [hardware/conveyor/](hardware/conveyor/) |
